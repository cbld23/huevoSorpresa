...
public class HuevoSorpresaLeraDiezCamilaBelen {
    ...
    private double precio_maxLedaDiezCamilaBelen2122;//precio máximo que puede tener un huevo sorpresa

    /*Constructor por defecto*/
    public HuevoSorpresaLeraDiezCamilaBelen() {
    }


    /*Constructor por parámetros*/
    public HuevoSorpresaLeraDiezCamilaBelen(int unidades, double precio, String sorpresa, double precio_max) {
        this.unidades = unidades;
        this.precio = precio;
        this.sorpresa = sorpresa;
        this.precio_maxLedaDiezCamilaBelen2122 = precio_max;
    }
...
suficientes unidades en la tienda*/
    ...
    public double getPrecio_maxLedaDiezCamilaBelen2122() {
        return precio_maxLedaDiezCamilaBelen2122;
    }
    ...
    public void setPrecio_maxLedaDiezCamilaBelen2122(double precio_maxLedaDiezCamilaBelen2122) {
        this.precio_maxLedaDiezCamilaBelen2122 = precio_maxLedaDiezCamilaBelen2122;
    }
}
